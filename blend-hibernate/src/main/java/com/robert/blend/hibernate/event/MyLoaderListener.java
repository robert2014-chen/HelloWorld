...
public class MyLoaderListener extends DefaultLoadEventListener {
	 ...
	 * 
	 * @see
	 * org.hibernate.event.internal.DefaultLoadEventListener#onLoad(org.hibernate
	 * .event.spi.LoadEvent, org.hibernate.event.spi.LoadEventListener.LoadType)
	 */
	@Override
	public void onLoad(LoadEvent event, LoadType loadType)
			throws HibernateException {
		System.out.println("继承系统默认的事件监听器");
