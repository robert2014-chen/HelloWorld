package com.robert.blend.spring.user.dao.impl;
...
public class UserDetailDaoImpl extends JdbcDaoSupport implements
		IUserDetailsDao {
	...
	public void updateFailAttempts(String username) {
		...
		if (user == null) {
			if (isUserExists(username)) {
				...
				System.out.println("insert in attempts");
	...
	private boolean isUserExists(String username) {
		...
		System.out.println("if user has been attempted");
